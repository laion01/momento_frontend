...
export default function Staking() {
    ...
    return (
        <div className="flex flex-col pt-[200px] z-10 relative lg:mx-[100px] md:mx-[80px] mx-[50px] pointer-events-none">
            <div className="">
                <h2 className="text-white text-[2rem]"> GB Staking </h2>
            </div>

            <div className="flex items-end">
                <button className={"min-w-[150px] px-[16px] py-[10px] mr-[10px] h-[50px] rounded-[8px] text-[1rem] pointer-events-auto" + (selectedTab == 0 ? " bg-[#AAEFFF] text-black" : " bg-[transparent] text-white")}
                    onClick={() => { selectTab(0)}}
                >
                    All
                </button>
                <button className={"min-w-[150px] px-[16px] py-[10px] mr-[10px] h-[50px] rounded-[8px] text-[1rem] pointer-events-auto" + (selectedTab == 1 ? " bg-[#AAEFFF] text-black" : " bg-[transparent text-white")}
                    onClick={() => { selectTab(1)}}
                >
                    Staked Ghost{stakedGhost > 0 ? `(${stakedGhost})` : ``}
                </button>
                <button className={"min-w-[150px] px-[16px] py-[10px] mr-[10px] h-[50px] rounded-[8px] text-[1rem] pointer-events-auto" + (selectedTab == 2 ? " bg-[#AAEFFF] text-black" : " bg-[transparent text-white")}
                    onClick={() => { selectTab(2)}}
                >
                ...
                <div className="flex bg-gradient-to-r border-[#400077] border-[2px] rounded-[10px]  h-[111px] w-[470px]"  style={{background: "linear-gradient(90deg, #AAEFFF 0%, #EEAFFF 100%)", boxShadow: "0px 5px 0px #400077"}}>
                    <div className="w-1/2 border-r-[2px] border-r-[black] flex flex-col px-[30px] justify-center">
                        <p className="text-[#6F617A] text-[1rem]"> Total Rewards</p>
                        <p className="text-white text-[2rem]"> { totalRewards } </p>
                    </div>
                    <div className="w-1/2 border-r-[2px] border-r-[black] flex flex-col px-[30px] justify-center">
                        <p className="text-[#6F617A] text-[1rem]"> Available for claim </p>
                        <p className="text-white text-[2rem]">$ 5.550 </p> 
                    </div>
                </div>
            </div>
