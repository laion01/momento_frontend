...
export default function Signin() {
    ...
    return (
        <div className="mx-[20px] md:mx-[40px] bg-[#F5F5F5] flex flex-col items-center pt-[8rem] pb-[3rem] min-h-[calc(100vh-1.5rem)] md:min-h-[calc(100vh-9rem)]">
            <div className="bg-white flex flex-col items-center p-[1.5rem] h-fit mx-[50px] mb-[2rem] shadow-md w-[calc(100%-40px)] md:w-[540px] mb-[2rem]">
                <p className="text-primary text-[1.5rem] text-center font-bold mb-[1.5rem] leading-[2.25rem]"> Sign-In </p>
                <input type="text" className="w-full h-[3rem] px-[10px] text-[1rem] outline-none border-[1px] border-[#D4D4D4] rounded-[4px] mb-[1rem]" placeholder="Email"/>
                ...
                <a target="_self"
                    className="border-b-[2px] border-[#996D01] text-primary text-[0.875rem] leading-[1.125rem] w-fit">
                    Forgot Password
                </a>
            </Link>
            </div>
